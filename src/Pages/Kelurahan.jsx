...
const Kelurahan = () => {
  const { id, id2, id3, id4 } = useParams();
    ...
    const fetchData = async () => {
      try {
        ...
        const responsePemilu = await fetch(
          `https://sirekap-obj-data.kpu.go.id/pemilu/hhcw/ppwp/${id}/${id2}/${id3}/${id4}.json`
        );
    ...
    <div className="body">
      ...
      <div className="container">
        ...
        <div className="hidden">
          <p>
            <strong>Tingkat Kelurahan</strong>
          </p>
          <p>
            ...
            {wilayahData.map((wilayah) => {
              ...
              return (
                <tr key={wilayah.kode}>
                  <td>
                    <Link
                      to={`/hitungsuara/${id}/${id2}/${id3}/${id4}/${wilayah.kode}`}
                    >
                      {wilayah.nama}
                    </Link>
                  </td>
